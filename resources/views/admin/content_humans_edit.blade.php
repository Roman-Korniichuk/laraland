<div class="wrapper container-fluid">
    {!! Form::open(['url'=>route('humansEdit', ['human'=>$data['id']]), 'class'=>'form-horizontal', 'method'=>'POST', 'enctype'=>'multipart/form-data']) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8">
                {!! Form::text('position', $data['position'], ['class'=>'form-control', 'placeholder'=>'Position']) !!}
            </div>
        </div>
